 ...
 *  @brief Computes the sun, moon, and nine JITmajor planets' equatorial position using JPL DE430 Ephemerides
 *
...
void JPL_Eph_DE430(double Mjd_TDB, Matrix& r_Mercury, Matrix& r_Venus, Matrix& r_Earth,
    ...
    temp = temp + 33;
    // Crear matrices temporales como lvalues
    ...
    // Asignar las temporales a Cx_Sun_full, Cy_Sun_full, Cz_Sun_full
    ...
    temp = temp + 30;
    // Crear matrices temporales como lvalues con nombres únicos
    ...
    // Asignar las temporales a Cx_Venus_full, Cy_Venus_full, Cz_Venus_full
